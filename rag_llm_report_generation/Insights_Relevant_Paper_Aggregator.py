...
from utils import generate_prediction_insights
from rag_llm_report_generation import get_top_feature_query, retrieve_relevant_chunks
...
def llm_input_aggregator(prediction_info=None, retrieved_docs=None):
    ...
    return llm_input_str, sources

if __name__ == "__main__":
    llm_input, sources = llm_input_aggregator()
    print(llm_input)
